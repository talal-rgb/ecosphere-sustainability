...
### 5. Academy Replaces Deep Dive — HYBRID MODEL APPROVED
**Decision:** Sustainability Academy will use the HYBRID model: Learning Paths + Professional Guides + Quizzes & Certification.  
**Structure:**
- Learning Paths (structured progression)
- Professional Guides (deep reference)
- Quizzes & Certification (engagement + credentials)
...
| 5 | Academy replaces Deep Dive — HYBRID model | 2026-07-22 | Pre-impl only | Tallal |
